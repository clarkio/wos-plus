...
- Test suite: **650 passing** Vitest tests across 19 files, plus **6
...
- Coverage: **90.99% statements / 86.62% branches / 88.06% functions /
  91.69% lines**. It counts **all** files under `src/**/*.ts`, so an untested
